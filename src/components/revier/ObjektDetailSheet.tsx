...
import type { Pruefung, PruefStatus } from '@/lib/revier/wartung'
// Die Zustandszeile samt Erfassung liegt seit dem 26.08.2026 in einer eigenen
// Datei — zeichengleich übernommen, nur um den Ladezustand ergänzt (den dieser
// Weg nicht braucht: hier lädt der Server). Zweiter Leser ist das
// Stand-Detail-Sheet der Jagdkarte; die Begründung steht dort im Dateikopf.
import { StandZustand } from '@/components/revier/StandZustand'
